...
export default function LoginMobileEmail({goToLoginNamePassword}) {
  ...
  return (
    ...
    <div className="w-full  flex flex-col justify-center items-center h-max mb-6 gap-y-6">
      ...
      <p>جهت ورود به سایت شماره موبایل/ایمیل خود را وارد کنید</p>
    </div>

    
      <form className="w-full h-38    flex  items-center ">
        <div className='w-full  flex flex-col items-center justify-center gap-y-5 text-sm '>
       <InputForm type="text" content="شماره موبایل / ایمیل" refrence={inputRef}/>
        <div className=' flex items-end  flex-col w-full'>
        
        </div>
        <div className='w-full h-[100px] translate-y-36 flex flex-col justify-between items-center  '>
        <button className='text-base'>ورود</button>
        <button onClick={goToLoginNamePassword} className='text-base text-cyan-700'>ورود با نام کاربر و رمز عبور</button>
        </div>
