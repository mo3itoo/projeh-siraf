...
export default function Registeration({getCodeButton}) {
    ...
    <div className="w-full  flex flex-col justify-center items-center h-max mb-6 gap-y-6">
      ...
      <form className="w-full h-38    flex  items-center ">
       ...
       <InputForm type="text" content="شماره موبایل / ایمیل" refrence={inputRef}/>
        ...
        <div className='w-full h-[100px] translate-y-20 flex flex-col justify-center items-center  '>
        <button className='text-base' onClick={getCodeButton}>دریافت کد تایید</button>
