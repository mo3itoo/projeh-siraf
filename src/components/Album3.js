        ...
        <div className="flex -translate-y-3 sm:translate-y-8 lg:translate-x-40 w-full items-center justify-center  gap-x-1 h-8   text-xsm text-white  px-1 rounded-sm">
          <div className="bg-gray-900 gap-x-1 p-1 rounded-md flex ">
            <Link
              ...
              className="flex items-center justify-center gap-x-1 opacity-70 bg-gray-900"
            >
              <p>youtube</p>
              <svg
            ...
            <Link
              ...
              className="flex items-center justify-center gap-x-1 bg-slate-700 p-1 rounded-md"
            >
              <p>twitter</p>
              <svg
                xmlns="http://www.w3.org/2000/svg"
          ...
          >
            ...
            >
              <div className="flex  items-center w-full  ">
                ...
                >
                  <p>استاد</p>
                  <p className="truncate w-60">{item.title}</p>
                </div>
              </div>
